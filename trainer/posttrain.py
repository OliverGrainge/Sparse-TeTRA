...
import numpy as np
from utils import load_model, load_posttrain_checkpoint2model
...
class PostTrainerModule(pl.LightningModule):
    def __init__(self,
        ...
        #self.model = load_posttrain_checkpoint2model(self.model, checkpoint_path)
    ...
    def on_validation_epoch_end(self):
        ...
        log_dataset = self.test_datasets[0].__repr__()
        self.log('val_recall', all_recalls[log_dataset][0])
    """
